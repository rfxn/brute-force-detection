...
#   ./tests/run-tests.sh --filter "validate"             # Filter by name
#   ./tests/run-tests.sh /opt/bfd/tests/17-check-pipeline.bats  # Specific file
#
...
for i in $(seq 0 $(( NUM_FILES - 1 ))); do
	...
	container_path="/opt/bfd/tests/$fname"
