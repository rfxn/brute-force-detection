...
check_file /usr/lib/bfd/internals/bfd.lib.sh "Library: bfd.lib.sh"
...
check_link /usr/local/bfd/internals/bfd.lib.sh /usr/lib/bfd/internals/bfd.lib.sh "Symlink: internals/bfd.lib.sh"
